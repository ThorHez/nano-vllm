...
from .tools.tool_converter import dict_to_tool_definition
...
class ChatCompletion:
    ...
    def register_function_as_tool(
        self, func, name: str = None, description: str = None
    ):
        """将函数注册为工具"""
    ...
    def create(
        ...
        **kwargs,
        ...
        if tools:
            ...
            for tool in tools:
                self.register_tool(dict_to_tool_definition(tool))
        ...
        for chunk in self.llm.generate_stream(prompt, sampling_params, use_tqdm=False):
            ...
            if not chunk["finished"]:
                ...
                if tool_names and collected_text:
                    current_tool_calls = self._parse_tool_calls(
                ...
                final_tool_calls = []
                if tool_names and collected_text:
                    final_tool_calls = self._parse_tool_calls(
                        collected_text, tool_names
                    )
